...
type AuthGrpcServiceClient interface {
	AccessTokenSearch(ctx context.Context, in *AccessTokenSearchReq, opts ...grpc.CallOption) (*AccessTokenRes, error)
...
func (c *authGrpcServiceClient) AccessTokenSearch(ctx context.Context, in *AccessTokenSearchReq, opts ...grpc.CallOption) (*AccessTokenRes, error) {
...
type AuthGrpcServiceServer interface {
	AccessTokenSearch(context.Context, *AccessTokenSearchReq) (*AccessTokenRes, error)
...
func (UnimplementedAuthGrpcServiceServer) AccessTokenSearch(context.Context, *AccessTokenSearchReq) (*AccessTokenRes, error) {
